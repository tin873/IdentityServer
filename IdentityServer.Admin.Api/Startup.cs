    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAdminAspNetIdentityServices<AdminIdentityDbContext, IdentityServerPersistedGrantDbContext,
                IdentityUserDto, IdentityRoleDto, User, Role, string, UserClaim, UserRole,
            ...
            services.AddMvcServices<IdentityUserDto, IdentityRoleDto,
                User, Role, string, UserClaim, UserRole,
                UserLogin, RoleClaim, UserToken,
                IdentityUsersDto, IdentityRolesDto, IdentityUserRolesDto,
                IdentityUserClaimsDto, IdentityUserProviderDto, IdentityUserProvidersDto, IdentityUserChangePasswordDto,
        ...
        {
            services.AddApiAuthentication<AdminIdentityDbContext, User, Role>(Configuration);
        }
